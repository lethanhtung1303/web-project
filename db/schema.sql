...
DROP TABLE IF EXISTS TDT_TYPE_PROPERTY;
...
CREATE TABLE TDT_TYPE_PROPERTY
(
    ...
    IS_DELETED CHAR(1 CHAR) DEFAULT '0' NOT NULL,
	PRIMARY KEY(TYPE_ID),
	CONSTRAINT UQ_TDT_TYPE_PROPERTY_01 UNIQUE(NAME)
);
...
ALTER TABLE TDT_PROPERTY
    ADD CONSTRAINT FK_TDT_PROPERTY_TDT_TYPE_PROPERTY FOREIGN KEY(TYPE_ID)
        REFERENCES TDT_TYPE_PROPERTY(TYPE_ID)
;
...
ALTER TABLE TDT_PROPERTY_INFO
    ADD CONSTRAINT FK_TDT_PROPERTY_INFO_TDT_USER FOREIGN KEY(USER_ID)
        REFERENCES TDT_USER(USER_ID)
;
